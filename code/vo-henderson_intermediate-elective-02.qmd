...
titles <- tibble(
  x = -1,
  y = 0, 
  label = "<span style='color:white;font-size:30pt'>**Native Vegetation Cover<br>
  across NCOS**</span><br>
<span style='color:white;font-size:18pt'>*2021 - 2025*</span><br><br>
<span style='color:white;font-size:12pt'>The proportion of vegetation cover that is<br><span style='color:#4CAF50'>native</span> has fluctuated over time, being lower on average<br>during early summer months.</span>."
)
...
- challenges you encountered as you made your visualization
  - Wrangling the vegetation dataset was definitely the most difficult part because I had to mentally work backwards from the variables I knew I needed at the end. The caption (which is still not perfect) was also difficult to format since I am not familiar with html scripting or the richtext geometry. 
